...
from scolar.views import canonical_redirect_enseignant_detail_view, media_access, quittances_access, pv  , gestion_cp , test_pdf_stage , test_pdf_stage_2
...
urlpatterns = [
    ...
    path('test_pdf_stage_2', test_pdf_stage_2, name='test_pdf_stage_2'),
