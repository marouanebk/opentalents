...
from scolar.views import canonical_redirect_enseignant_detail_view, media_access, quittances_access , GeneratePDFView , HeaderView , FooterView
...
urlpatterns = [
    ...
    path('generate_pdf/<int:pk>/<str:type>/', GeneratePDFView.as_view(), name='generate_pdf'),
