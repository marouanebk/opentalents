...
from scolar.views import canonical_redirect_enseignant_detail_view, media_access, quittances_access, pv  , gestion_cp , test_pdf_stage , TestPDFStage2View , TestPDFStage2ViewTemp , PDFVIEW
