...
class OrdreDuJour(models.Model):
    ...
    cp1 = models.ForeignKey(CP, related_name='ordre_du_jour_cp1', on_delete=models.CASCADE, null=True, blank=True)
    cp2 = models.ForeignKey(CP, related_name='ordre_du_jour_cp2', on_delete=models.CASCADE, null=True, blank=True)

class CP(models.Model):
    formation=models.ForeignKey(Formation, on_delete=models.SET_NULL, null=True, blank=True)
    periode=models.ForeignKey(Periode, on_delete=models.SET_NULL, null=True, blank=True)
    
    date_cp1=models.DateField(null=True, blank=True)
    description_cp1=models.TextField(null=True, blank=True)
    
    date_cp2=models.DateField(null=True, blank=True)
    description_cp2=models.TextField(null=True, blank=True)
    # ordre_du_jour_cp1 = models.ManyToManyField(OrdreDuJour, related_name='cp1_ordres', blank=True, null=True)
    # ordre_du_jour_cp2 = models.ManyToManyField(OrdreDuJour, related_name='cp2_ordres', blank=True, null=True)


    enseignants=models.ManyToManyField(Enseignant, blank=True , related_name='cp_enseignants' )

    ens_responsable = models.ForeignKey(Enseignant, on_delete=models.SET_NULL, null=True, blank=True, related_name='cp_ens_responsable')
