...
class CP(models.Model):
    ...
    ordre_du_jour_cp1 = models.ManyToManyField(OrdreDuJour, related_name='cp1_ordres', blank=True)
    ordre_du_jour_cp2 = models.ManyToManyField(OrdreDuJour, related_name='cp2_ordres', blank=True)
