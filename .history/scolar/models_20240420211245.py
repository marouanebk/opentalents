...
class CP(models.Model):
    ...
    enseignants=models.ManyToManyField(Enseignant, blank=True , related_name='enseignants' )

    ens_responsable = models.ForeignKey(Enseignant, on_delete=models.SET_NULL, null=True, blank=True, related_name='ens_responsable')
