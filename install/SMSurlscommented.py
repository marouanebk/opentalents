...
#from scolar.views import canonical_redirect_enseignant_detail_view
...
urlpatterns = [
 ...
 #   path('accounts/login/',views.LoginView.as_view(authentication_form=UserLoginForm),name='login'),
    ...
    #re_path(r'^ens/(?P<ens_nom>[a-zA-Z_éèàâôïùç-]+)/(?P<ens_prenom>[a-zA-Z_éèàâôïùç-]+)/$',canonical_redirect_enseignant_detail_view, name="redirect_canonical_enseignant_detail"),
]
